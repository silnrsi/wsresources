The el_GR.dic and el_GR.aff files are taken from the LibreOffice 
...
However, the encoding was for the ISO 8859-7 codepage. The encoding was changed to UTF-8.

The original README_el_GR.txt is below:
